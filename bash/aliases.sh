...
alias gl7="echo 'Running: git log -n6'; git log -n7"
alias gl8="echo 'Running: git log -n6'; git log -n8"
alias gl9="echo 'Running: git log -n6'; git log -n9"
alias gl10="echo 'Running: git log -n6'; git log -n10"
